...
void makeMuonHist(string inputFolder, string outputFile, string sampleTag = "Data")
{
    ...
    /// eos files
    string eosDirS = "/eos/user/a/asantra/MuonWorkingPointFiles";
    // local files
    // string eosDirS = "";
    /// local files
    ...
    TFile *myFile = new TFile((outputDirS + "/" + outputFile).c_str(), "RECREATE");
    myFile->cd();
    ...
    {
        // std::cout << dir_entry << '\n';
        // treeInFileS = eosDirS + "/" + inputFolder + "/" + inputSample +"_00000"+to_string(i+1)+".ANALYSIS.root";
    ...
    // //////////////////////////////
    // prepare1DHistogram(dCutLow, "lowpt", allHisto1Dict, prepared1DHistogram);
    // prepare2DHistogram(dCutLow, "lowpt", allHisto2Dict, prepared2DHistogram);

    // //////////////////////////////
    // /// tight working point //////
    // //////////////////////////////
    // prepare1DHistogram(dCutTight, "tight", allHisto1Dict, prepared1DHistogram);
